...
public class V3LabsTransPreorderRequestDemo extends BaseCommonDemo {
    public static void main(String[] args) throws Exception {
        ...
        v3LabsTransPreorderAlipayReq.setOutTradeNo("7089279514841772201");
        ...
        v3LabsTransPreorderAlipayReq.setNotifyUrl("http://47.105.146.241:9510/channelbacknotice/open/platform/transfer/V3");
        ...
        //响应信息
        String res = LKLSDK.httpPost(v3LabsTransPreorderUnionPayReq);
